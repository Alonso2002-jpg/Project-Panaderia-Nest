...
describe('ProductMapper', () => {
  ...
  it('should map createProductDto to Product', () => {
    const newProduct: Product = productMapper.toProductCreate(
      createProductDto,
      categoryProduct,
      provider,
    )
  ...
  it('should map updateProductDto to Product updating every fields', () => {
    const updatedProduct: Product = productMapper.toProductUpdate(
      updateProductDto1,
      product,
      categoryProduct2,
      provider2,
  ...
  it('should map Product to ResponseProductDto', () => {
    ...
    expect(response.image).toEqual(
      `https://localhost:3000/v1/storage/${product.image}`,
    )
