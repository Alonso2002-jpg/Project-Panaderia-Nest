...
describe('ProductService', () => {
  ...
  describe('findAll', () => {
    it('should return a paginated array of products response from database', async () => {
      ...
      jest
        .spyOn(mapper, 'toProductResponse')
    ...
    it('should return a paginated array of products response from cache', async () => {
      ...
      jest
        ...
        .mockResolvedValue(Promise.resolve(testProducts))
  ...
  describe('findOne', () => {
    it('should retrieve a product by id from database', async () => {
      ...
      expect(
        await service.findOne('5c9d94ac-344f-4992-a714-4243b0787263'),
      ).toEqual(resultDto)
      expect(mapper.toProductResponse).toHaveBeenCalled()
      expect(cacheManager.get).toHaveBeenCalledWith(
        'product_5c9d94ac-344f-4992-a714-4243b0787263',
      )
      expect(cacheManager.set).toHaveBeenCalled()
    })
    ...
    it('should retrieve a product by id from cache', async () => {
      ...
      jest
        .spyOn(cacheManager, 'get')
        .mockResolvedValue(Promise.resolve(resultDto))
    ...
    it('should throw an  error if the product doesn`t exist in database', async () => {
      ...
      await expect(
        service.findOne('5c9d94ac-344f-4992-a714-4243b0787263'),
  ...
  describe('create', () => {
    it('should create a new product', async () => {
      ...
      jest
        .spyOn(providerRepository, 'createQueryBuilder')
  ...
  describe('remove', () => {
    it('should remove a product by updating isDeleted to true', async () => {
      ...
      const actualResult = await service.remove(
        '5c9d94ac-344f-4992-a714-4243b0787263',
      )
    ...
    it('should throw an error if product doesn`t exist', async () => {
      ...
      await expect(
        service.remove('5c9d94ac-344f-4992-a714-4243b0787263'),
      ).rejects.toThrow(NotFoundException)
    })
  ...
  describe('Update image', () => {
    it('should update the product image', async () => {
      ...
      jest.spyOn(service, 'exists').mockResolvedValue(product)
    ...
    it('should throw an error if file not found', async () => {
      ...
      await expect(
        service.updateImage('5c9d94ac-344f-4992-a714-4243b0787263', null),
      ).rejects.toThrow(BadRequestException)
    })
  })
  ...
  describe('findCategory', () => {
    it('should return a category from cache', async () => {
      ...
      expect(await service.findCategory('Category Test')).toEqual(category)
    })
  })

  describe('findProvider', () => {
    it('should return a provider from cache', async () => {
      const provider = new ProvidersEntity()

      jest
        .spyOn(cacheManager, 'get')
        .mockResolvedValue(Promise.resolve(provider))

      expect(await service.findProvider('A29268166')).toEqual(provider)
    })
  })
})
